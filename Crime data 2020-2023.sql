...
--THIS QUERY WILL CHANGE THE DATA TYPE IN THE DATE REPORTED COLUMN FROM TEXT TO DATE
ALTER TABLE [Crime Data Analysis].[dbo].[Crime_Data_from_2020_to_Present$]
ALTER COLUMN [Date Reported] DATE

  --THIS QUERY WILL CHANGE THE DATA TYPE IN THE DATE OCCURED COLUMN FROM TEXT TO DATE
ALTER TABLE [Crime Data Analysis].[dbo].[Crime_Data_from_2020_to_Present$]
